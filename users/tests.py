...
class UserModelTest(TestCase):
    def test_telegram_id_unique(self):
        User.objects.create_user(username='user1', password='pass1', telegram_id='12345')
        with self.assertRaises(IntegrityError):
            User.objects.create_user(username='user2', password='pass2', telegram_id='12345')

    def test_create_user_with_telegram_id(self):
        user = User.objects.create_user(username='testuser', password='testpass', telegram_id='54321')
